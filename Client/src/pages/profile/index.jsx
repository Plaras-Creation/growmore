...
const Profile = () => {
    ...
    return(
        <div className="bg-[#1b1c24] h-[100vh] flex items-center
        justify-center flex-col gap-10">
            <div className="flex flex-col gap-10 w-[80vw] md:w-max">
                <div onClick={handleNavigate}>
                    <IoArrowBack className="text-4xllg:text-6xl text-white/90 cursor-pointer "/>
                </div>
                        ...
                        <Avatar className="h-32 w-32 md:w-48 md:h-48 rounded-full overflow-hidden">
                            {
                                ...
                                ( 
                                <div className={`uppercase h-32 w-full md:w48 md:h-48 text-5xl border-[1px] flex items-center justify-center rounded-full 
