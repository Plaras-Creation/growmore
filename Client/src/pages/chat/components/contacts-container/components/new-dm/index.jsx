...
const NewDM =() => {
    ...
    return(
        ...
        <Dialog open={openNewContactModel} onOpenChange={setOpenNewContactModel}>
            <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex
            flex-col">
                <DialogHeader>
                <DialogTitle>
                ...
                </div>
            {
                                    ...
                                    <Avatar className="h-12 w-12 rounded-full overflow-hidden">
                                        {
                                            ...
                                            ( 
                                            <div className={`uppercase h-12 w-full text-lg border-[1px] flex items-center justify-center rounded-full 
            ...
            )}
                {
                    ...
                    className="flex-1 md:flex mt-5 md:mt-0 flex-col justify-center 
                    items-center duration-1000 
                    transition-all">
                        <Lottie
